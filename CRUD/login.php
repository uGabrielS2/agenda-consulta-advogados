                ...
                <div id="tela" class="p-4 rounded shadow">
                    ...
                    <?php
                        if (isset($_GET['error']) && $_GET['error'] == 'credenciais_invalidas') {
                            echo '<div class="alert alert-danger" role="alert">Usuário ou senha incorretos! Tente novamente.<button type="button" class="btn-close p-2 ms-2" data-bs-dismiss="alert" aria-label="Close"></button></div>';
                        }
                        ?>
                        <div class="mb-3">
